...
const brandFields = [
  ...
  },
  {
    ...
    defaultValue: "",              // Default value, useful for resetting or pre-filling the field
    validation: { 
      required: "Logo is required"    // Custom validation error message for missing logo
    }
  }
];
...
const Brands = () => {
  ...
  const normalizeUser = (user, index) => ({
    ...
    status: getStatusLabel(String(user.brand_status)),
    brand_status_value: String(user.user_status), // ✅ Add this
  });
